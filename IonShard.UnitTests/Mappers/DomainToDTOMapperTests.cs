...
public class DomainToDtoMapperTests
{
    ...
    {
        IBuilderUnit builderUnit = new BuilderUnit(null, _userJohn, _sol, _earth, null, _clock);
    ...
    {
        IUnit builderUnit = new BuilderUnit(null, _userJohn, _sol, _earth, null, _clock);
